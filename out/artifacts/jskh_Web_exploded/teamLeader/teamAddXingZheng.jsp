...
<body>
 ...
 <div align="center"   >
<br/><br/><br/>
<h2><font color='blue' ><%=teamLeader.getPosition() %></font>:<font color='red' ><%=teamLeader.getTrueName() %></font></h2>
<br/>
     <h3>为团队添加新成员</h3>
     <br>
   ...
   <br>
    <form action="<%=basePath%>teamLeader/addXingZheng" method="post" >
      ...
      <table border="1" >
        <tr>
          <td align="right" width="80px">工号：</td><td><input type="number" name="userName" request="request"/></td>
        </tr>
        <tr>
          <td  align="right">姓名：</td><td><input type="text" name="trueName" request="request"/></td>
        </tr>
        <tr>
          <td  align="right">所在团队：</td><td><input type="text" name="team" value="<%=teamLeader.getManagerTeam() %>" readonly="readonly"/></td>
        </tr>
        <tr>
          <td  align="right">二级学院：</td><td><input type="text" name="team" value="<%=teamLeader.getDep() %>" readonly="readonly"/></td>
        </tr>
      </table>
