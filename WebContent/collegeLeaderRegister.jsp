...
<div class="bigbox">
    ...
    %>
    <form action="<%=basePath%>regCollegeLeader" method="post" class="form-userInfo">
        <h1>院级领导注册信息</h1>
        ...
        <label>
            <span>职称</span>
            <select class="teamType" name="level"  >
                <option value ="总书记">总书记</option>
                <option value ="院长">院长</option>
                <option value ="行政">副院长</option>
            </select>
        </label>
        <label>
            <span>团队类型</span>
