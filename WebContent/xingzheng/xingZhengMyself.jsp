...
//             out.println(" <a href='xingzhengMain.jsp'>退回行政人员主页</a>");
 ...
 <a href='xingzhengMain.jsp' class="leaveimp" >退回行政人员主页</a>
<div align="center"   >
<%
    ...
    <table class="one" id="one" border="1" >
      ...
      <tr>
       ...
       <tr>
        <td width="30px" align="center" height="30">1</td>
      ...
      <tr>
        <td width="30px" align="center" height="30">2</td>
    ...
    <table class="sex" id="sex" border="1" >
       ...
       <!--考核项六-->
      <tr>
        <td rowspan="14" width="30px" align="center" height="30">六</td>
       ...
       <tr>
        <td rowspan="1" width="50px" align="center"></td>
        <td width="30px" align="center" height="30">12</td>
      ...
      <tr>
        <td rowspan="1" width="50px" align="center"></td>
        <td width="30px" align="center" height="30">13</td>
      ...
      <tr>
        <td rowspan="1" width="50px" align="center"></td>
        <td width="30px" align="center" height="30">14</td>
       ...
       <tr>
        <td rowspan="1" width="50px" align="center"></td>
        <td width="30px" align="center" height="30">15</td>
       ...
       <tr>
        <td rowspan="1" width="50px" align="center"></td>
        <td width="30px" align="center" height="30">16</td>
       ...
       <tr>
        <td rowspan="1" width="50px" align="center"></td>
        <td width="30px" align="center" height="30">17</td>
       ...
       <tr>
        <td rowspan="1" width="50px" align="center"></td>
        <td width="30px" align="center" height="30">18</td>
       ...
       <tr>
        <td rowspan="1" width="50px" align="center"></td>
        <td width="30px" align="center" height="30">19</td>
       ...
       <tr>
        <td rowspan="1" width="50px" align="center"></td>
        <td width="30px" align="center" height="30">20</td>
       ...
       <tr>
        <td rowspan="1" width="50px" align="center"></td>
        <td width="30px" align="center" height="30">21</td>
       ...
       <tr>
        <td rowspan="1" width="50px" align="center"></td>
        <td width="30px" align="center" height="30">22</td>
       ...
       <tr>
        <td rowspan="1" width="50px" align="center"></td>
        <td width="30px" align="center" height="30">23</td>
       ...
       <tr>
        <td rowspan="1" width="50px" align="center"></td>
        <td width="30px" align="center" height="30">24</td>
       ...
       <!--总分-->
      <tr>
        <td  colspan="4"  align="center" height="40px" height="30">总分</td>
        <%
         if(xkh!=null){
        %>
        <td colspan="3" align="center"><font color='red' size='3'><%=xkh.getTotal_myself() %>分</font> </td> 
         <%}else { %>
        <td colspan="5" align="center"><font color='red' size='3'>0分</font> </td>
         <%}%>
      </tr>
    </table> 
