...
<div class="bigbox">
    ...
    %>
    <form action="<%=basePath%>regTeacher" method="post" class="form-userInfo">
        <h1>教师注册信息</h1>
...
<%--     <table border="1">--%>
<%--      <tr>--%>
<%--       <th align="right" height="30">用户名:<br/></th><td width="300px">
<input type="number" name="userName"  size="40" required="required" placeholder="请输入您的工号。提交后不能修改。"/></td>--%>
<%--     </tr>--%>
<%--     <tr>--%>
<%--       <th align="right" height="30">真实姓名：</th><td>
<input type="text" name="trueName" size="40" required="required"/></td>--%>
<%--     </tr>--%>
<%--     <tr>--%>
<%--       <th align="right" height="30">新密码：</th><td>
<input type="password" name="password" size="40" id="password" required="required" /></td>--%>
<%--     </tr>--%>
<%--     <tr>--%>
<%--       <th align="right" height="30">再次输入密码：</th><td>
<input type="password" name="password2" size="40" id="password2"  /></td>--%>
<%--     </tr>--%>
<%--     <tr>--%>
