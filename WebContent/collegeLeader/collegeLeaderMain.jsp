...
<body>
 <%
          ...
          if(collegeLeader==null){
            ...
            out.println(" <a href='../collegeLeaderExit'>退出登录</a>");
         
            %>

 <div align="center"   >
<br/><br/><br/>
<h2><font color='blue' ><%=collegeLeader.getDep()+"("+collegeLeader.getPosition()+")" %></font>:<font color='red' ><%=collegeLeader.getTrueName() %></font></h2><br/><br/>
     <%
