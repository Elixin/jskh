...
//              TeacherDao teacherDao = new TeacherDaoImpl();
            TeamLeader teamLeader=teamLeaderDao.getTeamLeaderById(id);
            %>
<div align="center"   >
<br/><br/><br/>
...
<%
   ...
   TKH tkh = teamLeaderDao.queryTHK(id);
%>

<form action="<%=basePath%>teamLeader/collegeLeaderToTeamLeaderKH" method="post" name="tkhbForm" >

<h1>信息工程学院专任教师工作量化考核表（<input type="text" name="year" value="<%=year%>" size="8"/>年）</h1>
    
         <table border="1" >
           <thead align="left">
             <h1><font color='red' size='3'><%=teamLeader.getTrueName() %>　/　<%=teamLeader.getPosition() %></font></h1>
           </thead>
           <tr>
       ...
       <th width="100px">团队负责人备注</th>
           ...
           <input type="hidden" name="id"  value="<%=teamLeader.getId() %>" />
